...
if os.path.exists(small_inputs): 
   ...
   ## f = open(os.path.join(output_dir, "small_output_parallel"), "w")
    for file in os.listdir(small_inputs): 
       ...
       ## run_executable('./lcs_parallel', [os.path.join(small_inputs, file), str(nthreads)], "small_output_parallel")
...
if os.path.exists(medium_inputs): 
    ...
    for file in os.listdir(medium_inputs): 
     ...
     ##   run_executable('./lcs_parallel', [os.path.join(medium_inputs, file), str(nthreads)], "medium_output_parallel")
...
##        run_executable('./lcs_parallel', [os.path.join(large_inputs, file), str(nthreads)], "large_output_parallel")
